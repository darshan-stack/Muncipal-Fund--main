...
const CitizenPortal = () => {
  ...
  const loadAllProjects = async () => {
    ...
    try {
      ...
      toast.success(`Loaded ${response.data?.length || 0} projects`);
    } catch (error) {
  ...
  const submitOpinion = async () => {
    ...
    if (!opinion.comment.trim()) {
      toast.error('Please write your opinion');
      return;
    }
    ...
    try {
      ...
      setOpinion({ rating: 5, comment: '', location: '' });
    } catch (error) {
      ...
      <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
        <Card className="w-full max-w-4xl max-h-[90vh] overflow-y-auto bg-slate-800 border-slate-700">
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <div className="flex items-center gap-2 text-slate-400">
                  <MapPin className="w-4 h-4" />
                  <span>{selectedProject.state}, {selectedProject.district}, {selectedProject.city}</span>
          ...
          <CardContent className="space-y-6">
            ...
            {showOpinionForm && (
              <div className="border-t border-slate-700 pt-4">
                <h3 className="text-lg font-semibold text-white mb-3">Submit Your Opinion</h3>
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Input
                      placeholder="e.g., Near this project"
